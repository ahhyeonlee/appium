...
class Device(models.Model):
    ...
    app_package = models.CharField(max_length=1000, null=True, blank=True, default="")
...
class Case(models.Model):
    ...
    element_id = models.CharField(max_length=1000, null=True,blank=True)
    element_value = models.CharField(max_length=1000, null=True,blank=True)
